...
@section('page_title', 'Tambah Cerita Baru')
...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('admin.stories.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select 
                    ...
                    required
                >
                    <option value="chart" {{ old('visualization_type') == 'chart' ? 'selected' : '' }}>Chart (Grafik)</option>
                    <option value="map" {{ old('visualization_type') == 'map' ? 'selected' : '' }}>Map (Peta)</option>
                    <option value="scrollytelling" {{ old('visualization_type') == 'scrollytelling' ? 'selected' : '' }}>Scrollytelling</option>
                    <option value="infographic" {{ old('visualization_type') == 'infographic' ? 'selected' : '' }}>Infographic</option>
                </select>
            </div>
        ...
        <div class="mt-8 flex justify-end space-x-4">
            <a href="{{ route('admin.stories.index') }}" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                Batal
            </a>
