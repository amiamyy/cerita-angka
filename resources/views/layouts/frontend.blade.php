...
<head>
    ...
    <title>@yield('title', 'Cerita Angka - BPS Kabupaten Bangkalan')</title>
    <meta name="description" content="@yield('meta_description', 'Website visualisasi data interaktif BPS Kabupaten Bangkalan')">
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('stories') }}" class="text-gray-700 hover:text-blue-600 transition">Cerita Data</a>
                    <a href="{{ route('datasets') }}" class="text-gray-700 hover:text-blue-600 transition">Dataset</a>
                    <a href="{{ route('about') }}" class="text-gray-700 hover:text-blue-600 transition">Tentang</a>
                </div>
            ...
            <div id="mobile-menu" class="hidden md:hidden mt-4 pb-4">
                ...
                <a href="{{ route('stories') }}" class="block py-2 text-gray-700 hover:text-blue-600">Cerita Data</a>
                <a href="{{ route('datasets') }}" class="block py-2 text-gray-700 hover:text-blue-600">Dataset</a>
        ...
        <div class="container mx-auto px-6 py-12">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="{{ route('stories') }}" class="text-blue-100 hover:text-white">Cerita Data</a></li>
                        <li><a href="{{ route('datasets') }}" class="text-blue-100 hover:text-white">Dataset</a></li>
                        <li><a href="{{ route('about') }}" class="text-blue-100 hover:text-white">Tentang Kami</a></li>
                    </ul>
                </div>
